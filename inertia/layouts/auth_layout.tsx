...
export const AuthLayout = ({ title, heading, description, children }: Props) => {
  return (
    <>
      <Head>
        <meta charSet="utf-8" />
      ...
      <div className="bg-gray-50 text-base antialiased text-gray-500">
            ...
            <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
              <div className="max-w-xl lg:max-w-3xl">
                ...
                <div className="lg:p-8">
                  <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-full lg:w-[350px]">
